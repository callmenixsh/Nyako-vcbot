	...
	for (let j = 0; j < 3; j++) {
		...
		await sleep(450);
			...
			const acceptedTexts = [
				...
				"slipped into the ritual naturally.",
				"was taken without resistance.",
				"vanished into the process.",
			];
			...
			const rejectedTexts = [
				...
				"escaped the process unnoticed.",
				"was not selected this time.",
				"got skipped by the ritual flow.",
				"was left out of the outcome.",
			];
			...
			if (isMulti) {
				...
				const frames = [
					...
					`${formatTargets(names)} ${pick([
						...
						"were taken before the system could react.",
